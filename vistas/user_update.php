<?php
    ...
    $id = (isset($_GET['user_edit'])) ? $_GET['user_edit'] : 0 ;
    limpiar_cadena($id);
?>
<body>
	<div class="container">
	...
	<div class="container">
		...
		<form action="php/usuario_actualizar.php" method="POST" class="formularioAjax" autocomplete="off" >
            ...
            <p class="has-text-centered">
            Para poder actualizar los datos de este usuario por favor ingrese su USUARIO y CLAVE con la que ha iniciado sesión			</p>
			<br>
			<div class="columns">
				<div class="column">
			    	<div class="control">
       ...
       <?php }else{
            alertError("A ocurrido un error","No es posible ejecutar este pedido");
            }
            $check_user=null;
         ?>
